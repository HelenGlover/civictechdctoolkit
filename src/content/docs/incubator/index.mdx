...
Civic tech is about communities, not just code. Getting the people side right is just as important as the technical decisions.
...
Every Civic Tech DC project should have a real-world partner so a nonprofit, government office, or community organization that validates the problem and will use or champion the output.
...
✅ Public GitHub repo created with README
